...
- hoopfire-addon: addon module, custom server and client side code 
- hoopfire-ui: main application module
- hoopfire-backend: backend module, contains any server side java code and dependencies
